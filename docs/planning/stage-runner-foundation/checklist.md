...
| 4 | [phase-04-stage-telemetry-foundation.md](./phase-04-stage-telemetry-foundation.md) | 5 | 5 | 100% | completed | - |
| 5 | [phase-05-legacy-job-runner-wrapper.md](./phase-05-legacy-job-runner-wrapper.md) | 6 | 6 | 100% | completed | - |
| 6 | [phase-06-foundation-tests-docs.md](./phase-06-foundation-tests-docs.md) | 5 | 5 | 100% | completed | - |
| **Total** | | **32** | **32** | **100%** | | |
...
- [x] 기존 create/resume/crop/review prompt-based workflow가 제거되지 않음
- [x] SQLite 또는 새 DB 의존성이 추가되지 않음
- [x] builder/checker/DeepSeek stage 이관이 이번 task에 포함되지 않음
- [x] `pnpm test` 또는 focused Vitest 명령이 통과함
- [x] TypeScript 타입 import가 기존 코드와 충돌하지 않음
