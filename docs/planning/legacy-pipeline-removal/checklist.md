...
|-------|------|------|------|--------|------|------|
| 1 | [phase-01-orchestrator-review-mode.md](./phase-01-orchestrator-review-mode.md) | 8 | 8 | 100% | completed | (pending commit) |
| 2 | [phase-02-followup-route-orchestrator.md](./phase-02-followup-route-orchestrator.md) | 7 | 0 | 0% | pending | - |
| 3 | [phase-03-crop-mode-migration.md](./phase-03-crop-mode-migration.md) | 5 | 0 | 0% | pending | - |
| 4 | [phase-04-sse-legacy-removal.md](./phase-04-sse-legacy-removal.md) | 8 | 0 | 0% | pending | - |
| 5 | [phase-05-dead-code-cleanup.md](./phase-05-dead-code-cleanup.md) | 7 | 0 | 0% | pending | - |
