...
#### Commit (orchestrator)
1874fad — feat(normalize): Phase 6 — R-07 2-pass LSUB codify + R-10 unary minus TS↔Python parity

#### E2E (orchestrator)
skip (env) — create-v4-full-pipeline / build-hwpx-cli 모두 delegate_to: run + 환경 의존. Phase 8 통합 검증으로 이양.
