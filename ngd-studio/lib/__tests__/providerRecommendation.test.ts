...
const telemetry: ProviderTelemetryEntry[] = [
  { stageKey: "review.reviewer", requestedProvider: "claude-cli", resolvedProvider: "claude-cli", attempt: 1, status: "success", elapsedMs: 3000, retry: false },
  { stageKey: "review.reviewer", requestedProvider: "claude-cli", resolvedProvider: "claude-cli", attempt: 1, status: "success", elapsedMs: 3200, retry: false },
  { stageKey: "review.reviewer", requestedProvider: "claude-cli", resolvedProvider: "claude-cli", attempt: 1, status: "success", elapsedMs: 3100, retry: false },
...
describe("stage provider recommendation", () => {
  it("keeps explicit stage overrides ahead of recommendations", () => {
    expect(recommendStageProvider({
      ...
      stageOverrides: { "review.reviewer": "codex-cli" },
      telemetry,
  ...
  it("rejects high failure rate and high cost candidates", () => {
    const failed: ProviderTelemetryEntry[] = [
      ...telemetry,
      { stageKey: "review.reviewer", requestedProvider: "codex-cli", resolvedProvider: "codex-cli", attempt: 1, status: "failed", elapsedMs: 10, retry: true },
      { stageKey: "review.reviewer", requestedProvider: "codex-cli", resolvedProvider: "codex-cli", attempt: 2, status: "failed", elapsedMs: 10, retry: true },
      { stageKey: "review.reviewer", requestedProvider: "codex-cli", resolvedProvider: "codex-cli", attempt: 3, status: "success", elapsedMs: 10, retry: false },
    ];
