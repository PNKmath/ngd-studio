...
> Source: [multica-ai/andrej-karpathy-skills/CLAUDE.md](https://github.com/multica-ai/andrej-karpathy-skills/blob/main/CLAUDE.md). This section governs **coding behavior**; the NGD section below governs **domain facts, formats, and file rules** — different planes, no conflict.
